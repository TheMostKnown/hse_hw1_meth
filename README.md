...
Построим график, показывающий уровень метилирования и покрытия всех трёх образцов:

<img src=https://github.com/TheMostKnown/hse_hw1_meth/blob/main/images/image_cov.png width=500/>  
